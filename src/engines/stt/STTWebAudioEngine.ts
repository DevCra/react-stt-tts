...
export default class STTWebAudioEngine implements STTEngine {
  ...
  stop() {
    ...
    console.log("Web Audio API stop");
  }

  mute() {
    // Actual Web Audio API mute logic will be implemented later
    console.log("Web Audio API mute");
  }

  unmute() {
    // Actual Web Audio API unmute logic will be implemented later
    console.log("Web Audio API unmute");
  }
}
